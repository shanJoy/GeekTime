...
class BannerView: UIView, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let view = cell.contentView.viewWithTag(BannerView.convertViewTag) {
            let _ = dataSource.viewForBanner(_bannerView: self, index: index, convertView: view)
        } else {
            let newView = dataSource.viewForBanner(_bannerView: self, index: index, convertView: nil)
    ...
    // UICollectionViewDelegateLayout - delegate
