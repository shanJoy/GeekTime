...
class LoginViewController: BaseViewController, ValidatesPhoneNumber, ValidatesPassword {
    ...
    override func viewDidLoad() {
        ...
        let logoView = UIImageView.init(image: R.image.logo())
        ...
        let phoneIconView = UIImageView.init(image: R.image.icon_phone())
        ...
        let passwordIconView = UIImageView.init(image: R.image.icon_pwd())
